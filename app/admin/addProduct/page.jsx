  ...
  return (
    <div className="flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-gradient-to-br from-blue-50 to-green-50 min-h-screen">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Create Health Article</h1>
          <p className="text-gray-600">Share valuable health insights with our community</p>
        </div>
          ...
          <form onSubmit={onSubmitHandler} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-gray-800 mb-2">Image Guidelines</h3>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500">
                Tip: Use clear headings, bullet points, and cite credible sources for better readability.
              </p>
            </div>
